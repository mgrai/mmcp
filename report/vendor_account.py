...
#     return args
#     
# def getOwedAmountBy2014(vendors, company):
#     owed_amount = 0
#     
...
#         owed_amount += (vendorSetting.before_2014_owed_amount or 0)
#             
#     return owed_amount
# 
# def getOwedInvoiceBy2014(vendors, company):
#     owed_invoice = 0
#     args = build_vendor_setting_parameters(vendors, company)
#      
#     vendorSettings = VendorSetting.objects.filter(*(args,))
#     
#     for vendorSetting in vendorSettings:
#             owed_invoice += (vendorSetting.before_2014_owed_invoice or 0)
#             
#     return owed_invoice  
# 
# 
...
# 
# 
# def getReceivedAmountBy2015Year2Month(vendors, company):
#     received_amount = 0
#     args = build_vendor_setting_parameters(vendors, company)
# 
#     vendorSettings = VendorSetting.objects.filter(*(args,))
#     for vendorSetting in vendorSettings:
#         received_amount += (vendorSetting.before_2015_2_received_amount or 0)
#             
...
#     #2014 欠款
#     owed_amount = getOwedAmountBy2014(vendor, company)
#     
#     if year == 2014:
#         return owed_amount
#     else:
...
#         
#         amount_before_2015_2 = getOwedAmountBy2015Year2Month(vendor, company)
#         
#         if year == 2015:
#             owed_amount = receiving_total + amount_before_2015_2
#         else:
...
#     #2014 欠发票
#     owed_invoice = getOwedInvoiceBy2014(vendor, company)
#         
#     if year == 2014:
#         return owed_invoice
#     else:
#         receiving_total = getTotalReceivingByMonth(year, month, vendor, company)
#         
#         amount_before_2015_2 = getOwedInvoiceBy2015Year2Month(vendor, company)
#         
#         if year == 2015:
#             owed_invoice = receiving_total + amount_before_2015_2
#         else:
