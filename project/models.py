...
#     estimate_user = models.ForeignKey(Employee, related_name='estimateGroup', verbose_name=u'预算负责人', limit_choices_to = Q( groups__name = u'预算部门') | Q( groups__name = u'预算部门经理'))
    estimate_user = models.ForeignKey(Employee, related_name='estimateGroup', verbose_name=u'预算负责人', blank=True, null=True)
    users = models.ManyToManyField(Employee, related_name='projectGroup', verbose_name=u'项目负责人')
